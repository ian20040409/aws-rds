                                    ...
                                    <div class="box">
                                        <form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="POST">
                                            ...
                                            <div class="row gtr-uniform">
                                                ...
                                                <div class="col-6 col-12-small">
                                                    <input type="text" name="PHONE" id="phone" value="<?php echo htmlspecialchars($contact_phone); ?>" placeholder="電話" maxlength="20" pattern="[0-9+\-\s]+" title="請輸入有效的電話號碼（僅包含數字、+、- 和空格）。" />
                                                </div>
                                                <div class="col-6 col-12-small">
